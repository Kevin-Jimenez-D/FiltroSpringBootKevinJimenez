...
ALTER TABLE
    `CostumerAudioVisual` ADD PRIMARY KEY(`audioVisual_ID`);
...
ALTER TABLE
    `Costumer` ADD CONSTRAINT `costumer_id_foreign` FOREIGN KEY(`id`) REFERENCES `CostumerAudioVisual`(`costumer_ID`);
ALTER TABLE
